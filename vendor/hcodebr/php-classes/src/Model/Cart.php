...
class Cart extends Model
{
    ...
    public function getProducts()
    {
        ...
        $results = $sql->select("
            ...
            ON a.idproduct = b.idproduct WHERE a.idcart = :idcart
    ...
    public function getProductsTotals()
    {
        ...
        $results = $sql->select("
            ...
            SUM(vlweight) as vlweight, COUNT(*) AS nrqtd FROM
            tb_products a INNER JOIN tb_cartsproducts b
    ...
    public function setFreight($nrzipcode)
    {
        ...
        if($totals['nrqtd'] > 0){
            ...
            //Organiza parâmetros de uma query a partir de um array
            $qs = http_build_query([
                'nCdEmpresa' => '',
                'sDsSenha' => '',
                'nCdServico' => '40010',
